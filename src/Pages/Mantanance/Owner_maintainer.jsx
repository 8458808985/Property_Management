    ...
    <div className="container my-3">
      <div className="row">
        <div className="col-md-6">
          <h5 className="my-2">All Maintainer</h5>
        </div>
...
data-bs-target="#exampleModal">Add Maintainer</button>
      ...
      <div className="row">
        <div className="col-md-12">
          ...
          {/* <h5>Add Maintainer</h5> */}
            ...
            <div className="col-md-6">
            <label htmlFor="" className='my-3'>Assign Property <span style={{color:"red"}}>*</span></label>
          <select class="form-select flex-shrink-0  p-3" id="search_property">
            <option value="" selected>
              Select Property
            </option>
...
export default Owner_maintainer
